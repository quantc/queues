...
// Example implementation from IBM MQ site.
// Queues are only access, not created.
// https://www.ibm.com/docs/en/ibm-mq/9.0?topic=programs-example-c-code-fragment-use-net
class MQSample
{
    ...
    const String connectionType = MQC.TRANSPORT_MQSERIES_BINDINGS;

    // Define the name of the queue manager to use (applies to all connections)
    const String qManager = "your_queuemanager";
